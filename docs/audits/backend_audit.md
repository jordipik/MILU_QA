...
- Backend funcional y estable para operación local.
...
- rate limiting para rutas write (si se amplía uso multiusuario)
...
3. Plan de seguridad para eventual exposición no-local.
