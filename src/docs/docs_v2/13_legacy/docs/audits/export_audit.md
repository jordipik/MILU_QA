...
- UI de revisiÃ³n export: export_wordpress.html + js/export-wordpress.js.
...
| LÃ³gica de merge extensa en generate_synthetic_exports.js (root) fuera del flujo oficial | Media | Confusion sobre cual pipeline manda |
...
2. AÃ±adir reporte de calidad export (completitud por campo requerido WP) previo a run-wordpress.
3. Consolidar y documentar deprecacion de generate_synthetic_exports.js root vs legacy/export_complex_ai.
4. AÃ±adir snapshot compare obligatorio antes de publicar output.
