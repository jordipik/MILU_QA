...
### FASE 1 â€” Cierre Read Compatibility
...
### FASE 2 â€” Export/Synthetic Semantic Audit
...
### FASE 4 â€” Escritura compatible

1. Objetivo.
- Definir y aplicar write-compat seguro sin migracion masiva de golpe.

2. Alcance.
- DiseÃ±ar writeAdapter/setField para estrategia de escritura (legacy, normalized o dual-write).
...
### FASE 6 â€” Limpieza legacy controlada
...
## Anexo â€” Alcance actual confirmado
