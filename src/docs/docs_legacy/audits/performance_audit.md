...
- Si hay múltiples pasadas/fallbacks por campos en modulos legacy (PN review y analista), elevando costo de mantenimiento y CPU.

## Recomendaciones

1. Activar por defecto carga incremental de motores en QA para sesiones no globales.
2. Separar orquestacion de eventos de qa-milu.js/analista-02.js en modulos pequeños.
3. Añadir medicion de tiempos por fase UI (load/filter/render/save).
4. Definir budget de latencia para endpoints analytics clave y alertas de regresion.
5. Añadir reconciliacion previa de media para reducir errores de render y operaciones redundantes.
