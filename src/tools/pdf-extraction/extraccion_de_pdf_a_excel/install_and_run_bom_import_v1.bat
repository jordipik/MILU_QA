@echo off
setlocal
REM MILU v6_2 - Instalación y ejecución BOM-IMPORT
cd /d %~dp0
...
REM Instalar requisitos principales
pip install -r requirements_v6_2.txt

REM milu_bom_import_v1.py necesita openpyxl para escribir XLSX
...
echo Ejecutando extracción BOM...
echo.

REM >>> LINEA CORREGIDA <<<
python milu_bom_import_v1.py --input .\milu-pdfs_v6_2 --output .\milu-out_v6_2
