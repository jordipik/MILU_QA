...
4. `js/analista-02.js` + `analista_02.html`
  - AÃ±aden una caja editable "Textos azules" en el panel PDF.
...
- conversiÃ³n de cada `bbox` a `fitz.Rect`
...
- numeros de posicion,
- pequeÃ±as etiquetas pegadas al dibujo,
...
2. `expand(final_rect, pad)` aÃ±ade margen exterior.
