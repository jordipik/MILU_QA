...
|---|---|---|
| Rutas rotas masivas | Alta | Export/QA visual inconsistente, errores en publicación |
| Dependencia de placeholders | Alta | Calidad de catálogo degradada |
| Orfandad de archivos locales | Media | Mantenimiento manual confuso |
| Duplicados de nombre | Media | Ambiguedad de resolución de recurso |
