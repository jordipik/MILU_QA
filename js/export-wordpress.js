...
async function loadAllData() {
    ...
    try {
        const [statusPayload, newPayload, supersededPayload, pendingPayload, discardedPayload, miluNewPayload] = await Promise.all([
            fetchJson(API.status),
            fetchFirstAvailableExportFile(TAB_CONFIG.new.jsonCandidates),
            fetchFirstAvailableExportFile(TAB_CONFIG.superseded.jsonCandidates),
            fetchFirstAvailableExportFile(TAB_CONFIG.pending.jsonCandidates),
            fetchFirstAvailableExportFile(TAB_CONFIG.discarded.jsonCandidates),
